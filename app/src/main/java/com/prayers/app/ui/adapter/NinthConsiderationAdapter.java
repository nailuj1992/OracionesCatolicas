...
public class NinthConsiderationAdapter extends RecyclerView.Adapter<ViewHolder> {

    private Context context;
    private NinthDay day;
    private AbstractActivity activity;

    public NinthConsiderationAdapter(AbstractActivity activity, NinthDay day) {
        this.day = day;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        String text = day.getConsiderations().get(i);
    ...
    public int getItemCount() {
        return day.getConsiderations().size();
    }
